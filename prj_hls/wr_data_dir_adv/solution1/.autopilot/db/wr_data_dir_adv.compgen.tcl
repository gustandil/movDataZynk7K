...
set id 1
set name wr_data_dir_adv_mac_muladd_12ns_11ns_11ns_22_4_1
...
set ce_signed 0
set out_width 22
set arg_lists {i0 {12 0 +} i1 {11 0 +} m {22 1 +} i2 {11 0 +} p {22 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 3 \
			corename wr_data_dir_adv_Axi_lite_axilite \
			name wr_data_dir_adv_Axi_lite_s_axi \
			ports {$port_Axi_lite} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler wr_data_dir_adv_Axi_lite_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_dir_TDATA { O 32 vector } s_dir_TVALID { O 1 bit } s_dir_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 's_dir'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { s_data_TDATA { O 32 vector } s_data_TVALID { O 1 bit } s_data_TREADY { I 1 bit } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 's_data'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_frame_ptr \
    op interface \
    ports { frame_ptr { I 2 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_completed \
    op interface \
    ports { completed { O 1 vector } } \
} "
}
...
# RegSlice definition:
set ID 15
set RegSliceName wr_data_dir_adv_regslice_both
set RegSliceInstName wr_data_dir_adv_regslice_both_U
set CoreName ap_simcore_wr_data_dir_adv_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
