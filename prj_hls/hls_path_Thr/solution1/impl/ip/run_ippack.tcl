...
set Library     "hls"
set IPName      "path_thr_axis"
set Version     "1.0"
set DisplayName "Path_thr_axis"
set Revision    "2113185562"
...
set xo_kernel_name "path_thr_axis"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/ITCL_video/movDataZynq/prj_hls/hls_path_Thr/solution1"
set debug_dir "D:/ITCL_video/movDataZynq/prj_hls/hls_path_Thr/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {path_thr_axis_Axi_lite_s_axi
...
## Variables
set Top "path_thr_axis"
set TopNoPrefix "path_thr_axis"
...
set Interfaces {
    s_axi_Axi_lite {
        ...
        registers {{0x10 statistics R 0x0 "Data signal of statistics" {{0 32 statistics R 0 "Bit 31 to 0 of statistics"}}} {0x14 statistics_ctrl R 0x0 "Control signal of statistics" {{0 1 statistics_ap_vld R 0 "Control signal statistics_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_Axi_lite strm_in strm_out"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 106 II x}
