; ModuleID = 'D:/ITCL_video/movDataZynq/prj_hls/collector_display/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_colector_display_ir(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(16) %strm_in, i32 %total_size, %"struct.ap_uint<1>"* noalias nocapture nonnull dereferenceable(1) %received, i64* noalias nocapture nonnull dereferenceable(8) %accum_total, i32* noalias nocapture nonnull dereferenceable(4) %processed_elem, i32* noalias nocapture nonnull dereferenceable(4) %received_img) local_unnamed_addr #0 {
entry:
  ...
  %received_copy = alloca i1, align 512
  %accum_total_copy = alloca i64, align 512
  %processed_elem_copy = alloca i32, align 512
  %received_img_copy = alloca i32, align 512
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* nonnull %strm_in, i64* %strm_in_copy.data, i8* %strm_in_copy.keep, i8* %strm_in_copy.strb, i1* %strm_in_copy.user, i1* %strm_in_copy.last, i1* %strm_in_copy.id, i1* %strm_in_copy.dest, %"struct.ap_uint<1>"* nonnull %received, i1* nonnull align 512 %received_copy, i64* nonnull %accum_total, i64* nonnull align 512 %accum_total_copy, i32* nonnull %processed_elem, i32* nonnull align 512 %processed_elem_copy, i32* nonnull %received_img, i32* nonnull align 512 %received_img_copy)
  call void @apatb_colector_display_hw(i64* %strm_in_copy.data, i8* %strm_in_copy.keep, i8* %strm_in_copy.strb, i1* %strm_in_copy.user, i1* %strm_in_copy.last, i1* %strm_in_copy.id, i1* %strm_in_copy.dest, i32 %total_size, i1* %received_copy, i64* %accum_total_copy, i32* %processed_elem_copy, i32* %received_img_copy)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %strm_in, i64* %strm_in_copy.data, i8* %strm_in_copy.keep, i8* %strm_in_copy.strb, i1* %strm_in_copy.user, i1* %strm_in_copy.last, i1* %strm_in_copy.id, i1* %strm_in_copy.dest, %"struct.ap_uint<1>"* %received, i1* %received_copy, i64* %accum_total, i64* %accum_total_copy, i32* %processed_elem, i32* %processed_elem_copy, i32* %received_img, i32* %received_img_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias "unpacked"="0", i64* noalias "unpacked"="1.0" %_V_data_V, i8* noalias "unpacked"="1.1" %_V_keep_V, i8* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_user_V, i1* noalias "unpacked"="1.4" %_V_last_V, i1* noalias "unpacked"="1.5" %_V_id_V, i1* noalias "unpacked"="1.6" %_V_dest_V, %"struct.ap_uint<1>"* noalias readonly "unpacked"="2", i1* noalias nocapture align 512 "unpacked"="3.0", i64* noalias readonly "unpacked"="4", i64* noalias align 512 "unpacked"="5", i32* noalias readonly "unpacked"="6", i32* noalias align 512 "unpacked"="7", i32* noalias readonly "unpacked"="8", i32* noalias align 512 "unpacked"="9") unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>.13"(i64* %_V_data_V, i8* %_V_keep_V, i8* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<1>"(i1* align 512 %2, %"struct.ap_uint<1>"* %1)
  call fastcc void @onebyonecpy_hls.p0i64(i64* align 512 %4, i64* %3)
...
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<1>"(i1* noalias nocapture align 512 "unpacked"="0.0" %dst, %"struct.ap_uint<1>"* noalias readonly "unpacked"="1" %src) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0i64(i64* noalias align 512 %dst, i64* noalias readonly %src) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias "unpacked"="0", i64* noalias "unpacked"="1.0" %_V_data_V, i8* noalias "unpacked"="1.1" %_V_keep_V, i8* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_user_V, i1* noalias "unpacked"="1.4" %_V_last_V, i1* noalias "unpacked"="1.5" %_V_id_V, i1* noalias "unpacked"="1.6" %_V_dest_V, %"struct.ap_uint<1>"* noalias "unpacked"="2", i1* noalias nocapture readonly align 512 "unpacked"="3.0", i64* noalias "unpacked"="4", i64* noalias readonly align 512 "unpacked"="5", i32* noalias "unpacked"="6", i32* noalias readonly align 512 "unpacked"="7", i32* noalias "unpacked"="8", i32* noalias readonly align 512 "unpacked"="9") unnamed_addr #5 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<1>.6"(%"struct.ap_uint<1>"* %1, i1* align 512 %2)
  call fastcc void @onebyonecpy_hls.p0i64(i64* %3, i64* align 512 %4)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @"onebyonecpy_hls.p0struct.ap_uint<1>.6"(%"struct.ap_uint<1>"* noalias "unpacked"="0" %dst, i1* noalias nocapture readonly align 512 "unpacked"="1.0" %src) unnamed_addr #4 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>.13"(i64* noalias "unpacked"="0.0" %dst_V_data_V, i8* noalias "unpacked"="0.1" %dst_V_keep_V, i8* noalias "unpacked"="0.2" %dst_V_strb_V, i1* noalias "unpacked"="0.3" %dst_V_user_V, i1* noalias "unpacked"="0.4" %dst_V_last_V, i1* noalias "unpacked"="0.5" %dst_V_id_V, i1* noalias "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>.16"(i64* %dst_V_data_V, i8* %dst_V_keep_V, i8* %dst_V_strb_V, i1* %dst_V_user_V, i1* %dst_V_last_V, i1* %dst_V_id_V, i1* %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>.16"(i64* noalias nocapture "unpacked"="0.0" %_V_data_V, i8* noalias nocapture "unpacked"="0.1" %_V_keep_V, i8* noalias nocapture "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture "unpacked"="0.3" %_V_user_V, i1* noalias nocapture "unpacked"="0.4" %_V_last_V, i1* noalias nocapture "unpacked"="0.5" %_V_id_V, i1* noalias nocapture "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias nocapture) unnamed_addr #3 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"
...
declare void @apatb_colector_display_hw(i64*, i8*, i8*, i1*, i1*, i1*, i1*, i32, i1*, i64*, i32*, i32*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias "unpacked"="0", i64* noalias "unpacked"="1.0" %_V_data_V, i8* noalias "unpacked"="1.1" %_V_keep_V, i8* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_user_V, i1* noalias "unpacked"="1.4" %_V_last_V, i1* noalias "unpacked"="1.5" %_V_id_V, i1* noalias "unpacked"="1.6" %_V_dest_V, %"struct.ap_uint<1>"* noalias "unpacked"="2", i1* noalias nocapture readonly align 512 "unpacked"="3.0", i64* noalias "unpacked"="4", i64* noalias readonly align 512 "unpacked"="5", i32* noalias "unpacked"="6", i32* noalias readonly align 512 "unpacked"="7", i32* noalias "unpacked"="8", i32* noalias readonly align 512 "unpacked"="9") unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %0, i64* %_V_data_V, i8* %_V_keep_V, i8* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V)
  call fastcc void @"onebyonecpy_hls.p0struct.ap_uint<1>.6"(%"struct.ap_uint<1>"* %1, i1* align 512 %2)
  call fastcc void @onebyonecpy_hls.p0i64(i64* %3, i64* align 512 %4)
...
define void @colector_display_hw_stub_wrapper(i64*, i8*, i8*, i1*, i1*, i1*, i1*, i32, i1*, i64*, i32*, i32*) #6 {
entry:
  %12 = alloca %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"
  %13 = alloca %"struct.ap_uint<1>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %12, i64* %0, i8* %1, i8* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"struct.ap_uint<1>"* %13, i1* %8, i64* null, i64* %9, i32* null, i32* %10, i32* null, i32* %11)
  call void @colector_display_hw_stub(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %12, i32 %7, %"struct.ap_uint<1>"* %13, i64* %9, i32* %10, i32* %11)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %12, i64* %0, i8* %1, i8* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"struct.ap_uint<1>"* %13, i1* %8, i64* null, i64* %9, i32* null, i32* %10, i32* null, i32* %11)
  ret void
}

declare void @colector_display_hw_stub(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"*, i32, %"struct.ap_uint<1>"*, i64*, i32*, i32*)
