...
#
# wrData_direct.tcl: Tcl script for re-creating project 'wrData_direct'
#
# Generated by Vivado on Fri Apr 17 14:14:36 +0200 2020
...
#
# 1. This project restoration tcl script (wrData_direct.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "../wrData_direct/wrData_direct.srcs/sources_1/bd/design_1/design_1.bd"
#    "../wrData_direct/wrData_direct.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
...
set _xil_proj_name_ "wrData_direct"
...
set script_file "wrData_direct.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/wrData_direct"]"
...
set files [list \
 [file normalize "${origin_dir}/wrData_direct/wrData_direct.srcs/sources_1/bd/design_1/design_1.bd"]\
 [file normalize "${origin_dir}/wrData_direct/wrData_direct.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"]\
]
...
if {[string equal [get_runs -quiet impl_2] ""]} {
    create_run -name impl_2 -part xc7z020clg400-1 -flow {Vivado Implementation 2018} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
