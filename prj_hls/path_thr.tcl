...
#
# Generated by Vivado on Wed Aug 30 11:15:46 +0200 2023
...
#
#    "d:/ITCL_video/movDataZynq/prj_vivado/path_thr/path_thr.srcs/sources_1/bd/design_1/design_1.bd"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../prj_vivado/path_thr/path_thr.srcs/sources_1/bd/design_1/design_1.bd"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/../prj_vivado/[file normalize "$origin_dir/"]"]"\
  ]
  foreach ipath $paths {
...
set orig_proj_dir "[file normalize "$origin_dir/../prj_vivado/path_thr"]"
...
set_property -name "board_part_repo_paths" -value "C:/Users/gsutter/AppData/Roaming/Xilinx/Vivado/2023.1/xhub/board_store/xilinx_board_store" -objects $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../prj_vivado/path_thr/path_thr.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
