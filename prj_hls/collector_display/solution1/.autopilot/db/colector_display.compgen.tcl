...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 1 \
			corename colector_display_Axi_lite_axilite \
			name colector_display_Axi_lite_s_axi \
			ports {$port_Axi_lite} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler colector_display_Axi_lite_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 0 \
    sync_rst true \
    corename dc_received \
    op interface \
    ports { received { O 1 vector } } \
} "
}
...
# RegSlice definition:
set ID 10
set RegSliceName colector_display_regslice_both
set RegSliceInstName colector_display_regslice_both_U
set CoreName ap_simcore_colector_display_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
