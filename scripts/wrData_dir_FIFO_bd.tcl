...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_dir_fifo, and set properties
  set axis_dir_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_dir_fifo ]
  set_property -dict [list \
    CONFIG.FIFO_DEPTH {512} \
    CONFIG.HAS_AEMPTY {1} \
    CONFIG.HAS_AFULL {1} \
...
\
  ...
  connect_bd_intf_net -intf_net adapter_axi_0_out_mm [get_bd_intf_pins adapter_axi_0/out_mm] [get_bd_intf_pins processing_system7_0/S_AXI_HP1]
connect_bd_intf_net -intf_net [get_bd_intf_nets adapter_axi_0_out_mm] [get_bd_intf_pins adapter_axi_0/out_mm] [get_bd_intf_pins system_ila_1/SLOT_0_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_vdma_0_M_AXIS_MM2S] [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins adapter_axi_0/axis_data] [get_bd_intf_pins axis_data_fifo/M_AXIS]
  connect_bd_intf_net -intf_net axis_dir_fifo_M_AXIS [get_bd_intf_pins adapter_axi_0/axis_dir] [get_bd_intf_pins axis_dir_fifo/M_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets processing_system7_0_M_AXI_GP0] [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins system_ila_0/SLOT_0_AXI]
  ...
  connect_bd_intf_net -intf_net wr_data_direct_1_s_data [get_bd_intf_pins axis_data_fifo/S_AXIS] [get_bd_intf_pins wr_data_direct_1/s_data]
connect_bd_intf_net -intf_net [get_bd_intf_nets wr_data_direct_1_s_data] [get_bd_intf_pins axis_data_fifo/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_2_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets wr_data_direct_1_s_data]
  connect_bd_intf_net -intf_net wr_data_direct_1_s_dir [get_bd_intf_pins axis_dir_fifo/S_AXIS] [get_bd_intf_pins wr_data_direct_1/s_dir]
connect_bd_intf_net -intf_net [get_bd_intf_nets wr_data_direct_1_s_dir] [get_bd_intf_pins axis_dir_fifo/S_AXIS] [get_bd_intf_pins system_ila_0/SLOT_3_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets wr_data_direct_1_s_dir]

  # Create port connections
  connect_bd_net -net almost_empty [get_bd_pins axis_data_fifo/almost_empty] [get_bd_pins system_ila_1/probe1]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets almost_empty]
  connect_bd_net -net almost_empty_1 [get_bd_pins axis_dir_fifo/almost_empty] [get_bd_pins system_ila_1/probe3]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets almost_empty_1]
  connect_bd_net -net almost_full [get_bd_pins axis_data_fifo/almost_full] [get_bd_pins system_ila_1/probe2]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets almost_full]
  connect_bd_net -net almost_full_1 [get_bd_pins axis_dir_fifo/almost_full] [get_bd_pins system_ila_1/probe4]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets almost_full_1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_vdma_0/m_axi_mm2s_aclk] [get_bd_pins axi_vdma_0/m_axis_mm2s_aclk] [get_bd_pins axi_vdma_0/s_axi_lite_aclk] [get_bd_pins axis_data_fifo/s_axis_aclk] [get_bd_pins axis_dir_fifo/s_axis_aclk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins system_ila_0/clk] [get_bd_pins wr_data_direct_1/ap_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins axis_data_fifo/m_axis_aclk] [get_bd_pins axis_dir_fifo/m_axis_aclk] [get_bd_pins processing_system7_0/S_AXI_HP1_ACLK] [get_bd_pins system_ila_1/clk] [get_bd_pins adapter_axi_0/clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net processing_system7_0_GPIO_O [get_bd_pins processing_system7_0/GPIO_O] [get_bd_pins axi_vdma_0/mm2s_fsync] [get_bd_pins system_ila_0/probe0] [get_bd_pins system_ila_1/probe0]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_nets processing_system7_0_GPIO_O]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_vdma_0/axi_resetn] [get_bd_pins axis_data_fifo/s_axis_aresetn] [get_bd_pins axis_dir_fifo/s_axis_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins system_ila_0/resetn] [get_bd_pins system_ila_1/resetn] [get_bd_pins wr_data_direct_1/ap_rst_n]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs wr_data_direct_1/s_axi_Axi_lite/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x40000000 -target_address_space [get_bd_addr_spaces adapter_axi_0/out_mm] [get_bd_addr_segs processing_system7_0/S_AXI_HP1/HP1_DDR_LOWOCM] -force
