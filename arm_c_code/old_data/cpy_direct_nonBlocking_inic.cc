...
#define COUNTERS_BASEADDR  XPAR_COUNTERS_WR_IP_0_BASEADDR
...
int main()
{
	...
	MovDataCopro_0.Axi_lite_BaseAddress = XPAR_WR_DATA_DIR_ADV_0_S_AXI_AXI_LITE_BASEADDR;
    ...
    COUNTERS_Reset(COUNTERS_BASEADDR, 0x0F);
	...
	uint valid_pix_lo = CNT_ReadReg(COUNTERS_BASEADDR, COUNTER_valid_pix_lo);
	uint valid_pix_hi = CNT_ReadReg(COUNTERS_BASEADDR, COUNTER_valid_pix_hi);
	uint not_Written  = CNT_ReadReg(COUNTERS_BASEADDR, COUNTER_not_Written );
	uint cnt_fifo_addr = CNT_ReadReg(COUNTERS_BASEADDR, COUNTER_fifo_addr  );
	uint cnt_fifo_data = CNT_ReadReg(COUNTERS_BASEADDR, COUNTER_fifo_data  );

	cout << "valid_pix_lo : " << valid_pix_lo  << "   not_Written  :  " << not_Written << endl ;
	cout << "cnt_fifo_addr: " << cnt_fifo_addr << "   cnt_fifo_data:  " << cnt_fifo_data << endl ;
