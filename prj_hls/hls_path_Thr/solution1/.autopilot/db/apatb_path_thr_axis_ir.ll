; ModuleID = 'D:/ITCL_video/movDataZynq/prj_hls/hls_path_Thr/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_path_thr_axis_ir(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(16) %strm_in, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(12) %strm_out, i32* noalias nocapture nonnull dereferenceable(4) %statistics) local_unnamed_addr #0 {
entry:
  ...
  %strm_out_copy.data = alloca i32
  %strm_out_copy.keep = alloca i4
  %strm_out_copy.strb = alloca i4
  %strm_out_copy.user = alloca i1
  %strm_out_copy.last = alloca i1
  %strm_out_copy.id = alloca i1
  %strm_out_copy.dest = alloca i1
  %statistics_copy = alloca i32, align 512
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* nonnull %strm_in, i64* %strm_in_copy.data, i8* %strm_in_copy.keep, i8* %strm_in_copy.strb, i1* %strm_in_copy.user, i1* %strm_in_copy.last, i1* %strm_in_copy.id, i1* %strm_in_copy.dest, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* nonnull %strm_out, i32* %strm_out_copy.data, i4* %strm_out_copy.keep, i4* %strm_out_copy.strb, i1* %strm_out_copy.user, i1* %strm_out_copy.last, i1* %strm_out_copy.id, i1* %strm_out_copy.dest, i32* nonnull %statistics, i32* nonnull align 512 %statistics_copy)
  call void @apatb_path_thr_axis_hw(i64* %strm_in_copy.data, i8* %strm_in_copy.keep, i8* %strm_in_copy.strb, i1* %strm_in_copy.user, i1* %strm_in_copy.last, i1* %strm_in_copy.id, i1* %strm_in_copy.dest, i32* %strm_out_copy.data, i4* %strm_out_copy.keep, i4* %strm_out_copy.strb, i1* %strm_out_copy.user, i1* %strm_out_copy.last, i1* %strm_out_copy.id, i1* %strm_out_copy.dest, i32* %statistics_copy)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %strm_in, i64* %strm_in_copy.data, i8* %strm_in_copy.keep, i8* %strm_in_copy.strb, i1* %strm_in_copy.user, i1* %strm_in_copy.last, i1* %strm_in_copy.id, i1* %strm_in_copy.dest, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %strm_out, i32* %strm_out_copy.data, i4* %strm_out_copy.keep, i4* %strm_out_copy.strb, i1* %strm_out_copy.user, i1* %strm_out_copy.last, i1* %strm_out_copy.id, i1* %strm_out_copy.dest, i32* %statistics, i32* %statistics_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias, i64* noalias "unpacked"="1.0" %_V_data_V, i8* noalias "unpacked"="1.1" %_V_keep_V, i8* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_user_V, i1* noalias "unpacked"="1.4" %_V_last_V, i1* noalias "unpacked"="1.5" %_V_id_V, i1* noalias "unpacked"="1.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias, i32* noalias "unpacked"="3.0" %_V_data_V1, i4* noalias "unpacked"="3.1" %_V_keep_V2, i4* noalias "unpacked"="3.2" %_V_strb_V3, i1* noalias "unpacked"="3.3" %_V_user_V4, i1* noalias "unpacked"="3.4" %_V_last_V5, i1* noalias "unpacked"="3.5" %_V_id_V6, i1* noalias "unpacked"="3.6" %_V_dest_V7, i32* noalias readonly, i32* noalias align 512) unnamed_addr #1 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>.15"(i64* %_V_data_V, i8* %_V_keep_V, i8* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"(i32* %_V_data_V1, i4* %_V_keep_V2, i4* %_V_strb_V3, i1* %_V_user_V4, i1* %_V_last_V5, i1* %_V_id_V6, i1* %_V_dest_V7, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %1)
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"(i32* noalias "unpacked"="0.0" %dst_V_data_V, i4* noalias "unpacked"="0.1" %dst_V_keep_V, i4* noalias "unpacked"="0.2" %dst_V_strb_V, i1* noalias "unpacked"="0.3" %dst_V_user_V, i1* noalias "unpacked"="0.4" %dst_V_last_V, i1* noalias "unpacked"="0.5" %dst_V_id_V, i1* noalias "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"(i32* %dst_V_data_V, i4* %dst_V_keep_V, i4* %dst_V_strb_V, i1* %dst_V_user_V, i1* %dst_V_last_V, i1* %dst_V_id_V, i1* %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"(i32* noalias nocapture "unpacked"="0.0" %_V_data_V, i4* noalias nocapture "unpacked"="0.1" %_V_keep_V, i4* noalias nocapture "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture "unpacked"="0.3" %_V_user_V, i1* noalias nocapture "unpacked"="0.4" %_V_last_V, i1* noalias nocapture "unpacked"="0.5" %_V_id_V, i1* noalias nocapture "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias nocapture) unnamed_addr #3 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias, i64* noalias "unpacked"="1.0" %_V_data_V, i8* noalias "unpacked"="1.1" %_V_keep_V, i8* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_user_V, i1* noalias "unpacked"="1.4" %_V_last_V, i1* noalias "unpacked"="1.5" %_V_id_V, i1* noalias "unpacked"="1.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias, i32* noalias "unpacked"="3.0" %_V_data_V1, i4* noalias "unpacked"="3.1" %_V_keep_V2, i4* noalias "unpacked"="3.2" %_V_strb_V3, i1* noalias "unpacked"="3.3" %_V_user_V4, i1* noalias "unpacked"="3.4" %_V_last_V5, i1* noalias "unpacked"="3.5" %_V_id_V6, i1* noalias "unpacked"="3.6" %_V_dest_V7, i32* noalias, i32* noalias readonly align 512) unnamed_addr #5 {
entry:
  ...
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.4"(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %1, i32* %_V_data_V1, i4* %_V_keep_V2, i4* %_V_strb_V3, i1* %_V_user_V4, i1* %_V_last_V5, i1* %_V_id_V6, i1* %_V_dest_V7)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %2, i32* align 512 %3)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.4"(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias align 512 %dst, i32* noalias "unpacked"="1.0" %src_V_data_V, i4* noalias "unpacked"="1.1" %src_V_keep_V, i4* noalias "unpacked"="1.2" %src_V_strb_V, i1* noalias "unpacked"="1.3" %src_V_user_V, i1* noalias "unpacked"="1.4" %src_V_last_V, i1* noalias "unpacked"="1.5" %src_V_id_V, i1* noalias "unpacked"="1.6" %src_V_dest_V) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.7"(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* nonnull align 512 %dst, i32* %src_V_data_V, i4* %src_V_keep_V, i4* %src_V_strb_V, i1* %src_V_user_V, i1* %src_V_last_V, i1* %src_V_id_V, i1* %src_V_dest_V)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.7"(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias nocapture align 512, i32* noalias nocapture "unpacked"="1.0" %_V_data_V, i4* noalias nocapture "unpacked"="1.1" %_V_keep_V, i4* noalias nocapture "unpacked"="1.2" %_V_strb_V, i1* noalias nocapture "unpacked"="1.3" %_V_user_V, i1* noalias nocapture "unpacked"="1.4" %_V_last_V, i1* noalias nocapture "unpacked"="1.5" %_V_id_V, i1* noalias nocapture "unpacked"="1.6" %_V_dest_V) unnamed_addr #3 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"
  %2 = alloca i32
  %3 = alloca i4
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>.15"(i64* noalias "unpacked"="0.0" %dst_V_data_V, i8* noalias "unpacked"="0.1" %dst_V_keep_V, i8* noalias "unpacked"="0.2" %dst_V_strb_V, i1* noalias "unpacked"="0.3" %dst_V_user_V, i1* noalias "unpacked"="0.4" %dst_V_last_V, i1* noalias "unpacked"="0.5" %dst_V_id_V, i1* noalias "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias %src) unnamed_addr #2 {
entry:
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>.18"(i64* %dst_V_data_V, i8* %dst_V_keep_V, i8* %dst_V_strb_V, i1* %dst_V_user_V, i1* %dst_V_last_V, i1* %dst_V_id_V, i1* %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>.18"(i64* noalias nocapture "unpacked"="0.0" %_V_data_V, i8* noalias nocapture "unpacked"="0.1" %_V_keep_V, i8* noalias nocapture "unpacked"="0.2" %_V_strb_V, i1* noalias nocapture "unpacked"="0.3" %_V_user_V, i1* noalias nocapture "unpacked"="0.4" %_V_last_V, i1* noalias nocapture "unpacked"="0.5" %_V_id_V, i1* noalias nocapture "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias nocapture) unnamed_addr #3 {
entry:
  %1 = alloca %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"
...
declare void @apatb_path_thr_axis_hw(i64*, i8*, i8*, i1*, i1*, i1*, i1*, i32*, i4*, i4*, i1*, i1*, i1*, i1*, i32*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias, i64* noalias "unpacked"="1.0" %_V_data_V, i8* noalias "unpacked"="1.1" %_V_keep_V, i8* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_user_V, i1* noalias "unpacked"="1.4" %_V_last_V, i1* noalias "unpacked"="1.5" %_V_id_V, i1* noalias "unpacked"="1.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* noalias, i32* noalias "unpacked"="3.0" %_V_data_V1, i4* noalias "unpacked"="3.1" %_V_keep_V2, i4* noalias "unpacked"="3.2" %_V_strb_V3, i1* noalias "unpacked"="3.3" %_V_user_V4, i1* noalias "unpacked"="3.4" %_V_last_V5, i1* noalias "unpacked"="3.5" %_V_id_V6, i1* noalias "unpacked"="3.6" %_V_dest_V7, i32* noalias, i32* noalias readonly align 512) unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %0, i64* %_V_data_V, i8* %_V_keep_V, i8* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>.4"(%"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %1, i32* %_V_data_V1, i4* %_V_keep_V2, i4* %_V_strb_V3, i1* %_V_user_V4, i1* %_V_last_V5, i1* %_V_id_V6, i1* %_V_dest_V7)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %2, i32* align 512 %3)
...
define void @path_thr_axis_hw_stub_wrapper(i64*, i8*, i8*, i1*, i1*, i1*, i1*, i32*, i4*, i4*, i1*, i1*, i1*, i1*, i32*) #6 {
entry:
  %15 = alloca %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"
  %16 = alloca %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %15, i64* %0, i8* %1, i8* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %16, i32* %7, i4* %8, i4* %9, i1* %10, i1* %11, i1* %12, i1* %13, i32* null, i32* %14)
  call void @path_thr_axis_hw_stub(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %15, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %16, i32* %14)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %15, i64* %0, i8* %1, i8* %2, i1* %3, i1* %4, i1* %5, i1* %6, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"* %16, i32* %7, i4* %8, i4* %9, i1* %10, i1* %11, i1* %12, i1* %13, i32* null, i32* %14)
  ret void
}

declare void @path_thr_axis_hw_stub(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"*, %"class.hls::stream<hls::axis<ap_uint<32>, 1, 1, 1>, 0>"*, i32*)
