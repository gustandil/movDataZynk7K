...
set Library     "hls"
set IPName      "cpyData_copro"
set Version     "1.0"
set DisplayName "Cpydata_copro"
set Revision    "2113186191"
...
set xo_kernel_name "cpyData_copro"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/ITCL_video/movDataZynq/prj_hls/cpy_Data/solution1"
set debug_dir "D:/ITCL_video/movDataZynq/prj_hls/cpy_Data/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {cpyData_copro_mac_muladd_12ns_11ns_11ns_23_4_1
...
## Variables
set Top "cpyData_copro"
set TopNoPrefix "cpyData_copro"
...
set Interfaces {
    s_axi_Axi_lite {
        type "axi4lite"
        mode "slave"
        port_prefix "s_axi_Axi_lite"
        param_prefix "C_S_AXI_AXI_LITE"
        addr_bits "7"
        port_width "AWADDR 7 WDATA 32 WSTRB 4 ARADDR 7 RDATA 32"
        registers {{0x10 width_img W 0x0 "Data signal of width_img" {{0 32 width_img W 0 "Bit 31 to 0 of width_img"}}} {0x18 rows_count R 0x0 "Data signal of rows_count" {{0 32 rows_count R 0 "Bit 31 to 0 of rows_count"}}} {0x1c rows_count_ctrl R 0x0 "Control signal of rows_count" {{0 1 rows_count_ap_vld R 0 "Control signal rows_count_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 cols_count R 0x0 "Data signal of cols_count" {{0 32 cols_count R 0 "Bit 31 to 0 of cols_count"}}} {0x2c cols_count_ctrl R 0x0 "Control signal of cols_count" {{0 1 cols_count_ap_vld R 0 "Control signal cols_count_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 maxcol_cnt R 0x0 "Data signal of maxcol_cnt" {{0 32 maxcol_cnt R 0 "Bit 31 to 0 of maxcol_cnt"}}} {0x3c maxcol_cnt_ctrl R 0x0 "Control signal of maxcol_cnt" {{0 1 maxcol_cnt_ap_vld R 0 "Control signal maxcol_cnt_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 statistics R 0x0 "Data signal of statistics" {{0 32 statistics R 0 "Bit 31 to 0 of statistics"}}} {0x4c statistics_ctrl R 0x0 "Control signal of statistics" {{0 1 statistics_ap_vld R 0 "Control signal statistics_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    s_axi_control {
        ...
        registers {{0x10 memW_1 W 0x0 "Data signal of memW" {{0 32 memW W 0 "Bit 31 to 0 of memW"}}} {0x14 memW_2 W 0x0 "Data signal of memW" {{0 32 memW W 0 "Bit 63 to 32 of memW"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_Axi_lite s_axi_control m_axi_memWR strm_in"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_memWR {
        ...
        data_width "32"
        port_prefix "m_axi_memWR"
        param_prefix "C_M_AXI_MEMWR"
...
## System Info
set user_parameters_list {clk_period 6 machine 64 combinational 0 latency 11 II 1}
