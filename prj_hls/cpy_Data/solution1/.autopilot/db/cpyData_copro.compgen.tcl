...
set id 1
set name cpyData_copro_mac_muladd_12ns_11ns_11ns_23_4_1
...
set ce_signed 0
set out_width 23
set arg_lists {i0 {12 0 +} i1 {11 0 +} m {23 1 +} i2 {11 0 +} p {23 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cpyData_copro_memWR_m_axi BINDTYPE {interface} TYPE {adapter} IMPL {m_axi}
}
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 3 \
			corename cpyData_copro_Axi_lite_axilite \
			name cpyData_copro_Axi_lite_s_axi \
			ports {$port_Axi_lite} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cpyData_copro_Axi_lite_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 4 \
			corename cpyData_copro_control_axilite \
			name cpyData_copro_control_s_axi \
			ports {$port_control} \
			op interface \
			interrupt_clear_mode TOW \
			interrupt_trigger_type default \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cpyData_copro_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 13
set RegSliceName cpyData_copro_regslice_both
set RegSliceInstName cpyData_copro_regslice_both_U
set CoreName ap_simcore_cpyData_copro_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
