...
using hls::sim::Byte;
extern "C" void wr_data_direct(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, int, volatile void *);
extern "C" void apatb_wr_data_direct_hw(volatile void * __xlx_apatb_param_strm_in_V_data_V, volatile void * __xlx_apatb_param_strm_in_V_keep_V, volatile void * __xlx_apatb_param_strm_in_V_strb_V, volatile void * __xlx_apatb_param_strm_in_V_user_V, volatile void * __xlx_apatb_param_strm_in_V_last_V, volatile void * __xlx_apatb_param_strm_in_V_id_V, volatile void * __xlx_apatb_param_strm_in_V_dest_V, volatile void * __xlx_apatb_param_s_dir, volatile void * __xlx_apatb_param_s_data, int __xlx_apatb_param_width_img, int __xlx_apatb_param_base_addr, volatile void * __xlx_apatb_param_statistics) {
...
auto* ss_data = createStream(__xlx_apatb_param_s_data, 4);
  // DUT call
  wr_data_direct(sstrm_in_V_data_V->data<long long>(), sstrm_in_V_keep_V->data<char>(), sstrm_in_V_strb_V->data<char>(), sstrm_in_V_user_V->data<char>(), sstrm_in_V_last_V->data<char>(), sstrm_in_V_id_V->data<char>(), sstrm_in_V_dest_V->data<char>(), __xlx_apatb_param_s_dir, __xlx_apatb_param_s_data, __xlx_apatb_param_width_img, __xlx_apatb_param_base_addr, __xlx_apatb_param_statistics);
