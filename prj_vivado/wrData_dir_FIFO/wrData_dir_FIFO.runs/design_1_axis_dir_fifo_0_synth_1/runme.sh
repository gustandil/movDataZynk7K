...
HD_PWD='d:/ITCL_video/movDataZynq/prj_vivado/wrData_dir_FIFO/wrData_dir_FIFO.runs/design_1_axis_dir_fifo_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axis_dir_fifo_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axis_dir_fifo_0.tcl
