...
/* Definitions for driver WR_DATA_DIRECT */
#define XPAR_XWR_DATA_DIRECT_NUM_INSTANCES 1

/* Definitions for peripheral WR_DATA_DIRECT_1 */
#define XPAR_WR_DATA_DIRECT_1_DEVICE_ID 0
#define XPAR_WR_DATA_DIRECT_1_S_AXI_AXI_LITE_BASEADDR 0x40000000
#define XPAR_WR_DATA_DIRECT_1_S_AXI_AXI_LITE_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral WR_DATA_DIRECT_1 */
#define XPAR_XWR_DATA_DIRECT_0_DEVICE_ID XPAR_WR_DATA_DIRECT_1_DEVICE_ID
#define XPAR_XWR_DATA_DIRECT_0_S_AXI_AXI_LITE_BASEADDR 0x40000000
#define XPAR_XWR_DATA_DIRECT_0_S_AXI_AXI_LITE_HIGHADDR 0x4000FFFF
