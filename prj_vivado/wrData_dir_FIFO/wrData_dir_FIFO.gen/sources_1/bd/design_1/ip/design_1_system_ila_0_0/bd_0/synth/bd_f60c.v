...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI:SLOT_1_AXIS:SLOT_2_AXIS:SLOT_3_AXIS, ASSOCIATED_RESET resetn, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input clk;
  input [0:0]probe0;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        ...
        .probe36(net_slot_1_axis_tdata),
        .probe37(net_slot_1_axis_tkeep),
        .probe38(net_slot_1_axis_tuser),
        .probe39(net_slot_1_axis_tvalid),
        .probe4(net_slot_0_axi_arcache),
        .probe40(net_slot_1_axis_tready),
        .probe41(net_slot_1_axis_tlast),
        .probe42(net_slot_2_axis_tdata),
        .probe43(net_slot_2_axis_tvalid),
        .probe44(net_slot_2_axis_tready),
        .probe45(net_slot_2_axis_tlast),
        .probe46(net_slot_3_axis_tdata),
        .probe47(net_slot_3_axis_tvalid),
        .probe48(net_slot_3_axis_tready),
        .probe49(net_slot_3_axis_tlast),
