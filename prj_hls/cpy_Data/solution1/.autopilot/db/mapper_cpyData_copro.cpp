...
using hls::sim::Byte;
extern "C" void cpyData_copro(Byte<4>*, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, int, volatile void *, volatile void *, volatile void *, volatile void *);
extern "C" void apatb_cpyData_copro_hw(volatile void * __xlx_apatb_param_strm_in_V_data_V, volatile void * __xlx_apatb_param_strm_in_V_keep_V, volatile void * __xlx_apatb_param_strm_in_V_strb_V, volatile void * __xlx_apatb_param_strm_in_V_user_V, volatile void * __xlx_apatb_param_strm_in_V_last_V, volatile void * __xlx_apatb_param_strm_in_V_id_V, volatile void * __xlx_apatb_param_strm_in_V_dest_V, volatile void * __xlx_apatb_param_memW, int __xlx_apatb_param_width_img, volatile void * __xlx_apatb_param_rows_count, volatile void * __xlx_apatb_param_cols_count, volatile void * __xlx_apatb_param_maxcol_cnt, volatile void * __xlx_apatb_param_statistics) {
using hls::sim::createStream;
  // Collect __xlx_memW__tmp_vec
std::vector<Byte<4>> __xlx_memW__tmp_vec;
for (size_t i = 0; i < 65536; ++i){
__xlx_memW__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_memW)[i]);
}
  int __xlx_size_param_memW = 65536;
  int __xlx_offset_param_memW = 0;
  int __xlx_offset_byte_param_memW = 0*4;
...
auto* sstrm_in_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_strm_in_V_dest_V);
  // DUT call
  cpyData_copro(__xlx_memW__tmp_vec.data(), sstrm_in_V_data_V->data<long long>(), sstrm_in_V_keep_V->data<char>(), sstrm_in_V_strb_V->data<char>(), sstrm_in_V_user_V->data<char>(), sstrm_in_V_last_V->data<char>(), sstrm_in_V_id_V->data<char>(), sstrm_in_V_dest_V->data<char>(), __xlx_offset_byte_param_memW, __xlx_apatb_param_width_img, __xlx_apatb_param_rows_count, __xlx_apatb_param_cols_count, __xlx_apatb_param_maxcol_cnt, __xlx_apatb_param_statistics);
// print __xlx_apatb_param_memW
for (size_t i = 0; i < __xlx_size_param_memW; ++i) {
((Byte<4>*)__xlx_apatb_param_memW)[i] = __xlx_memW__tmp_vec[__xlx_offset_param_memW+i];
}
