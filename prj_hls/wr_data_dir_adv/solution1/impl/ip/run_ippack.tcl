...
set Library     "hls"
set IPName      "wr_data_dir_adv"
set Version     "1.0"
set DisplayName "Wr_data_dir_adv"
set Revision    "2113190190"
...
set xo_kernel_name "wr_data_dir_adv"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/ITCL_video/movDataZynq/prj_hls/wr_data_dir_adv/solution1"
set debug_dir "D:/ITCL_video/movDataZynq/prj_hls/wr_data_dir_adv/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {wr_data_dir_adv_mac_muladd_12ns_11ns_11ns_22_4_1
...
## Variables
set Top "wr_data_dir_adv"
set TopNoPrefix "wr_data_dir_adv"
...
set Interfaces {
    s_axi_Axi_lite {
        ...
        registers {{0x10 base_addr_0 W 0x0 "Data signal of base_addr_0" {{0 32 base_addr_0 W 0 "Bit 31 to 0 of base_addr_0"}}} {0x18 base_addr_1 W 0x0 "Data signal of base_addr_1" {{0 32 base_addr_1 W 0 "Bit 31 to 0 of base_addr_1"}}} {0x20 base_addr_2 W 0x0 "Data signal of base_addr_2" {{0 32 base_addr_2 W 0 "Bit 31 to 0 of base_addr_2"}}} {0x28 base_addr_3 W 0x0 "Data signal of base_addr_3" {{0 32 base_addr_3 W 0 "Bit 31 to 0 of base_addr_3"}}} {0x30 width_img W 0x0 "Data signal of width_img" {{0 32 width_img W 0 "Bit 31 to 0 of width_img"}}} {0x38 total_size W 0x0 "Data signal of total_size" {{0 32 total_size W 0 "Bit 31 to 0 of total_size"}}} {0x40 processed_elem R 0x0 "Data signal of processed_elem" {{0 32 processed_elem R 0 "Bit 31 to 0 of processed_elem"}}} {0x44 processed_elem_ctrl R 0x0 "Control signal of processed_elem" {{0 1 processed_elem_ap_vld R 0 "Control signal processed_elem_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_Axi_lite strm_in s_dir s_data"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
...
## System Info
set user_parameters_list {clk_period 6 machine 64 combinational 0 latency 4 II 1}
