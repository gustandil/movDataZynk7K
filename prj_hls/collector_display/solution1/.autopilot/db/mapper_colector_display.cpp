...
using hls::sim::Byte;
extern "C" void colector_display(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, int, volatile void *, volatile void *, volatile void *, volatile void *);
extern "C" void apatb_colector_display_hw(volatile void * __xlx_apatb_param_strm_in_V_data_V, volatile void * __xlx_apatb_param_strm_in_V_keep_V, volatile void * __xlx_apatb_param_strm_in_V_strb_V, volatile void * __xlx_apatb_param_strm_in_V_user_V, volatile void * __xlx_apatb_param_strm_in_V_last_V, volatile void * __xlx_apatb_param_strm_in_V_id_V, volatile void * __xlx_apatb_param_strm_in_V_dest_V, int __xlx_apatb_param_total_size, volatile void * __xlx_apatb_param_received, volatile void * __xlx_apatb_param_accum_total, volatile void * __xlx_apatb_param_processed_elem, volatile void * __xlx_apatb_param_received_img) {
...
auto* sstrm_in_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_strm_in_V_dest_V);
  // DUT call
  colector_display(sstrm_in_V_data_V->data<long long>(), sstrm_in_V_keep_V->data<char>(), sstrm_in_V_strb_V->data<char>(), sstrm_in_V_user_V->data<char>(), sstrm_in_V_last_V->data<char>(), sstrm_in_V_id_V->data<char>(), sstrm_in_V_dest_V->data<char>(), __xlx_apatb_param_total_size, __xlx_apatb_param_received, __xlx_apatb_param_accum_total, __xlx_apatb_param_processed_elem, __xlx_apatb_param_received_img);
