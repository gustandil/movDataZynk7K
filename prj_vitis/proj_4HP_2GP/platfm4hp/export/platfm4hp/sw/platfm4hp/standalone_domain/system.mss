...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = display_0_axi_vdma_display0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = colector_display
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = display_0_colector_display_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.13
 PARAMETER HW_INSTANCE = display_1_axi_vdma_display1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = colector_display
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = display_1_colector_display_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.9
 PARAMETER HW_INSTANCE = frame_ptrs
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.13
 PARAMETER HW_INSTANCE = matrix_0_axi_vdma_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.13
 PARAMETER HW_INSTANCE = matrix_1_axi_vdma_1
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = wr_data_dir_adv
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = write_module_0_wr_data_dir_adv_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = wr_data_dir_adv
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = write_module_1_wr_data_dir_adv_1
END
