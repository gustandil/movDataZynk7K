...
HD_PWD='d:/ITCL_video/movDataZynq/prj_vivado/path_thr/path_thr.runs/design_1_path_thr_axis_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_path_thr_axis_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_path_thr_axis_0_0.tcl
