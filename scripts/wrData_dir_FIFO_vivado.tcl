...
#
# wrData_dir_FIFO.tcl: Tcl script for re-creating project 'wrData_dir_FIFO'
#
# Generated by Vivado on Fri Apr 17 23:33:41 +0200 2020
...
#
# 1. This project restoration tcl script (wrData_dir_FIFO.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "../wrData_dir_FIFO/wrData_dir_FIFO.srcs/sources_1/bd/design_1/design_1.bd"
#    "../wrData_dir_FIFO/wrData_dir_FIFO.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "../hdl_src/adapter_axi.vhd"
#
...
set _xil_proj_name_ "wrData_dir_FIFO"
...
set script_file "wrData_dir_FIFO.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/wrData_dir_FIFO"]"
...
add_files -norecurse  ${origin_dir}/../hdl_src/adapter_axi.vhd
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../hdl_src/adapter_axi.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Add local files from the original project (-no_copy_sources specified)
set files [list \
 [file normalize "${origin_dir}/wrData_dir_FIFO/wrData_dir_FIFO.srcs/sources_1/bd/design_1/design_1.bd" ]\
 [file normalize "${origin_dir}/wrData_dir_FIFO/wrData_dir_FIFO.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]\
]
set added_files [add_files -fileset sources_1 $files]

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../hdl_src/adapter_axi.vhd"
