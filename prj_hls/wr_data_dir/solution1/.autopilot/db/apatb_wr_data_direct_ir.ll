; ModuleID = 'D:/ITCL_video/movDataZynq/prj_hls/wr_data_dir/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_wr_data_direct_ir(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias nonnull dereferenceable(16) %strm_in, i32* noalias nonnull dereferenceable(4) %s_dir, i32* noalias nonnull dereferenceable(4) %s_data, i32 %width_img, i32 %base_addr, i32* noalias nocapture nonnull dereferenceable(4) %statistics) local_unnamed_addr #0 {
entry:
  ...
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* nonnull %strm_in, i64* %strm_in_copy.data, i8* %strm_in_copy.keep, i8* %strm_in_copy.strb, i1* %strm_in_copy.user, i1* %strm_in_copy.last, i1* %strm_in_copy.id, i1* %strm_in_copy.dest, i32* nonnull %s_dir, i32* nonnull align 512 %s_dir_copy, i32* nonnull %s_data, i32* nonnull align 512 %s_data_copy, i32* nonnull %statistics, i32* nonnull align 512 %statistics_copy)
  call void @apatb_wr_data_direct_hw(i64* %strm_in_copy.data, i8* %strm_in_copy.keep, i8* %strm_in_copy.strb, i1* %strm_in_copy.user, i1* %strm_in_copy.last, i1* %strm_in_copy.id, i1* %strm_in_copy.dest, i32* %s_dir_copy, i32* %s_data_copy, i32 %width_img, i32 %base_addr, i32* %statistics_copy)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %strm_in, i64* %strm_in_copy.data, i8* %strm_in_copy.keep, i8* %strm_in_copy.strb, i1* %strm_in_copy.user, i1* %strm_in_copy.last, i1* %strm_in_copy.id, i1* %strm_in_copy.dest, i32* %s_dir, i32* %s_dir_copy, i32* %s_data, i32* %s_data_copy, i32* %statistics, i32* %statistics_copy)
  ret void
}

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias, i64* noalias "unpacked"="1.0" %_V_data_V, i8* noalias "unpacked"="1.1" %_V_keep_V, i8* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_user_V, i1* noalias "unpacked"="1.4" %_V_last_V, i1* noalias "unpacked"="1.5" %_V_id_V, i1* noalias "unpacked"="1.6" %_V_dest_V, i32* noalias readonly, i32* noalias align 512, i32* noalias readonly, i32* noalias align 512, i32* noalias readonly, i32* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias, i64* noalias "unpacked"="1.0" %_V_data_V, i8* noalias "unpacked"="1.1" %_V_keep_V, i8* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_user_V, i1* noalias "unpacked"="1.4" %_V_last_V, i1* noalias "unpacked"="1.5" %_V_id_V, i1* noalias "unpacked"="1.6" %_V_dest_V, i32* noalias, i32* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_wr_data_direct_hw(i64*, i8*, i8*, i1*, i1*, i1*, i1*, i32*, i32*, i32, i32, i32*)

; Function Attrs: argmemonly noinline
define internal fastcc void @copy_back(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* noalias, i64* noalias "unpacked"="1.0" %_V_data_V, i8* noalias "unpacked"="1.1" %_V_keep_V, i8* noalias "unpacked"="1.2" %_V_strb_V, i1* noalias "unpacked"="1.3" %_V_user_V, i1* noalias "unpacked"="1.4" %_V_last_V, i1* noalias "unpacked"="1.5" %_V_id_V, i1* noalias "unpacked"="1.6" %_V_dest_V, i32* noalias, i32* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512, i32* noalias, i32* noalias readonly align 512) unnamed_addr #5 {
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>.4"(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %0, i64* %_V_data_V, i8* %_V_keep_V, i8* %_V_strb_V, i1* %_V_user_V, i1* %_V_last_V, i1* %_V_id_V, i1* %_V_dest_V)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %1, i32* align 512 %2)
  call fastcc void @onebyonecpy_hls.p0i32(i32* %3, i32* align 512 %4)
...
define void @wr_data_direct_hw_stub_wrapper(i64*, i8*, i8*, i1*, i1*, i1*, i1*, i32*, i32*, i32, i32, i32*) #6 {
entry:
  %12 = alloca %"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"
  call void @copy_out(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %12, i64* %0, i8* %1, i8* %2, i1* %3, i1* %4, i1* %5, i1* %6, i32* null, i32* %7, i32* null, i32* %8, i32* null, i32* %11)
  call void @wr_data_direct_hw_stub(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %12, i32* %7, i32* %8, i32 %9, i32 %10, i32* %11)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"* %12, i64* %0, i8* %1, i8* %2, i1* %3, i1* %4, i1* %5, i1* %6, i32* null, i32* %7, i32* null, i32* %8, i32* null, i32* %11)
  ret void
}

declare void @wr_data_direct_hw_stub(%"class.hls::stream<hls::axis<ap_uint<64>, 1, 1, 1>, 0>"*, i32*, i32*, i32, i32, i32*)
