...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { strm_in_TDATA { I 64 vector } strm_in_TVALID { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { strm_in_TREADY { O 1 bit } strm_in_TDEST { I 1 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { strm_out_TDATA { O 32 vector } strm_out_TREADY { I 1 bit } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { strm_out_TVALID { O 1 bit } strm_out_TDEST { O 1 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_addr_load \
    op interface \
    ports { addr_load { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_statistics \
    op interface \
    ports { statistics { O 32 vector } statistics_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 17 \
    name addr_flag_0_out \
    type other \
    dir O \
    reset_level 1 \
    sync_rst true \
    corename dc_addr_flag_0_out \
    op interface \
    ports { addr_flag_0_out { O 1 vector } addr_flag_0_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_addr_loc_0_out \
    op interface \
    ports { addr_loc_0_out { O 32 vector } addr_loc_0_out_ap_vld { O 1 bit } } \
} "
}
