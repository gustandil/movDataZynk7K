...
set Library     "hls"
set IPName      "colector_display"
set Version     "1.0"
set DisplayName "Colector_display"
set Revision    "2113190207"
...
set xo_kernel_name "colector_display"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "D:/ITCL_video/movDataZynq/prj_hls/collector_display/solution1"
set debug_dir "D:/ITCL_video/movDataZynq/prj_hls/collector_display/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {colector_display_Axi_lite_s_axi
...
## Variables
set Top "colector_display"
set TopNoPrefix "colector_display"
...
set Interfaces {
    s_axi_Axi_lite {
        ...
        registers {{0x10 total_size W 0x0 "Data signal of total_size" {{0 32 total_size W 0 "Bit 31 to 0 of total_size"}}} {0x18 accum_total_1 R 0x0 "Data signal of accum_total" {{0 32 accum_total R 0 "Bit 31 to 0 of accum_total"}}} {0x1c accum_total_2 R 0x0 "Data signal of accum_total" {{0 32 accum_total R 0 "Bit 63 to 32 of accum_total"}}} {0x20 accum_total_ctrl R 0x0 "Control signal of accum_total" {{0 1 accum_total_ap_vld R 0 "Control signal accum_total_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 processed_elem R 0x0 "Data signal of processed_elem" {{0 32 processed_elem R 0 "Bit 31 to 0 of processed_elem"}}} {0x34 processed_elem_ctrl R 0x0 "Control signal of processed_elem" {{0 1 processed_elem_ap_vld R 0 "Control signal processed_elem_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 received_img R 0x0 "Data signal of received_img" {{0 32 received_img R 0 "Bit 31 to 0 of received_img"}}} {0x44 received_img_ctrl R 0x0 "Control signal of received_img" {{0 1 received_img_ap_vld R 0 "Control signal received_img_ap_vld"} {1 31 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 7 machine 64 combinational 0 latency 1 II 1}
