#*****************************************************************************************
# Original version: Vivado (TM) v2018.3 (64-bit). Updated 2023.1
#
# path_thr.tcl: Tcl script for re-creating project 'path_thr'
#
# Generated by Vivado on Tue Apr 14 20:24:33 +0200 2020
...
#
# 1. This project restoration tcl script (path_thr.tcl) that was generated.
#
...
#
#    "../path_thr/path_thr.srcs/sources_1/bd/design_1/design_1.bd"
#    "../path_thr/path_thr.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"
#
# -- Update ago23. Change board version Zybo 1.1
# -- replaced deprecated  dsa.*
#
#*****************************************************************************************
...
set orig_proj_dir "[file normalize "$origin_dir/path_thr"]"
...
set_property "ip_repo_paths" "[file normalize "$origin_dir/../prj_hls"]" $obj
...
# Create block design
source $origin_dir/../scripts/${_xil_proj_name_}_bd.tcl

# Generate the wrapper and add to the proj
make_wrapper -files [get_files ${_xil_proj_name_}/${_xil_proj_name_}.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse  ${_xil_proj_name_}/${_xil_proj_name_}.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/path_thr/path_thr.srcs/sources_1/bd/design_1/design_1.bd"] \
 [file normalize "${origin_dir}/path_thr/path_thr.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/path_thr/path_thr.srcs/sources_1/bd/design_1/design_1.bd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "registered_with_manager" -value "1" -objects $file_obj

set file "$origin_dir/path_thr/path_thr.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.vhd"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
